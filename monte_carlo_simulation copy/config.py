...
MAX_TIME_STEPS = 5000  # maximum simulation steps (same as original)
...
OWNSHIP_SIZE = 0.5  # m
OWNSHIP_MAX_RATE_OF_TURN = [12.0, 12.0]  # deg/s (original default)
...
SHIP_A_SIZE_RANGE = [0.3, 1.0]  # [min, max] m
SHIP_A_VELOCITY_RANGE = [0.5, 3.0]  # [min, max] m/s
