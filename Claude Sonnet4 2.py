...
class Ship:
    ...
    def __init__(self, name, position, velocity, heading, size=10.0, max_turn_rate=10.0, max_angular_accel=10.0):
        ...
        self.max_turn_rate = np.radians(max_turn_rate)
        self.max_angular_accel = np.radians(max_angular_accel)
...
class BarrierController:
    ...
    def compute_control(self, current_bearing, angular_size, dt, current_time):
        """
        Compute control action - FIXED VERSION with proper angle difference
        修正版：正確處理角度差分
        """
